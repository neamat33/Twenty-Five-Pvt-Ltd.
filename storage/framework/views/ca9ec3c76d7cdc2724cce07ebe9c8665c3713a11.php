...
<?php $__env->startSection('title_area', 'Mufti Osman Goni Salehi'); ?>
    ...
    <div class="container">
      ...
      <div class="do_container">
        <div class="box arrow-start arrow_bg">
          <div class="img-box">
            <img src="<?php echo e(asset('web')); ?>/assets/images/d-5.png" alt="">
          </div>
          <div class="detail-box">
            <h6>
        ...
        <div class="box arrow-middle arrow_bg">
          <div class="img-box">
            <img src="<?php echo e(asset('web')); ?>/assets/images/d-2.png" alt="">
          </div>
          <div class="detail-box">
            <h6>
              Product Maintenance
        ...
        <div class="box arrow-middle arrow_bg">
          <div class="img-box">
            <img src="<?php echo e(asset('web')); ?>/assets/images/d-3.png" alt="">
          </div>
          <div class="detail-box">
            <h6>
              IT Consulting
        ...
        <div class="box arrow-end arrow_bg">
          <div class="img-box">
            <img src="<?php echo e(asset('web')); ?>/assets/images/d-4.png" alt="">
          </div>
          <div class="detail-box">
            <h6>
              DevOps
        ...
        <div class="box ">
          <div class="img-box">
            ...
            <img src="<?php echo e(asset('web')); ?>/assets/images/d-1.png" alt="">
          </div>
          <div class="detail-box">
            <h6>
              Marketing
  ...
  <section class="work_section layout_padding">
    <div class="container">
      ...
      <div class="work_container layout_padding2">
        <div class="box b-1">
          <img src="<?php echo e(asset('web')); ?>/assets/images/w-1.png" alt="">
        </div>
        <div class="box b-2">
          <img src="<?php echo e(asset('web')); ?>/assets/images/w-2.png" alt="">

        </div>
        <div class="box b-3">
          <img src="<?php echo e(asset('web')); ?>/assets/images/w-3.png" alt="">

        </div>
        <div class="box b-4">
          <img src="<?php echo e(asset('web')); ?>/assets/images/w-4.png" alt="">
      ...
      <div class="carousel-wrap ">
        <div class="owl-carousel">
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="<?php echo e(asset('web')); ?>/assets/images/c-1.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Sajib Biswas <br>
                ...
                <img src="<?php echo e(asset('web')); ?>/assets/images/quote.png" alt="">
                <p>
          ...
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="<?php echo e(asset('web')); ?>/assets/images/c-2.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Bapon Sheikh <br>
          ...
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="<?php echo e(asset('web')); ?>/assets/images/c-3.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Al Jubaiar<br>
...
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\putul\p_web\resources\views/web/home.blade.php ENDPATH**/ ?>